...
for i in range(3000): #820
    batch = get_batch(ecog_train, spkrspec_train,word_window_train,seg_length=width-64/4, batch_size=32, threshold = 0.0)
    # batch = get_batch(ecog, spkr,word_window_train,seg_length=width-64/4, batch_size=32, threshold = 0.0)
    ...
    if i%50== 49:
        ...
        batch = get_batch(ecog_train, spkrspec_train,word_window_train,seg_length=width-64/4, batch_size=32)
        # batch = get_batch(ecog_train, spkrspec_train,filter_width=100,seg_length=width-64/4, batch_size=32,threshold = 0.0)
