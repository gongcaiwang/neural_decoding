# CoADly1Trans.mat: 
# transfers from gdat_env3.mat by eigenvectors generated from Max-correlation Matrix*Delay Matrix; stores under key 'xx'
# Shape: (854493,62), bad nodes: [1,25], Threshold=0.1
# [max,min] = [33,-12]

# MaxCo1Trans.mat:
# transfers from gdat_env3.mat by eigenvectors generated from Max-correlation Matrix; stores under key 'xx'
# Shape: (854493,56), bad nodes: [0, 1, 23, 24, 25, 33, 34, 42], Threshold=0.15
# [max,min] = [30,-25]

# Co1Trans.mat:
# transfers from gdat_env3.mat by eigenvectors generated from Correlation Matrix; stores under key 'xx'
# Shape: (854493,59), bad nodes: [0, 1, 24, 25, 42], Threshold=0.1
# [max,min] = [15,-28]

# Delay1Trans.mat:
# transfers from gdat_env3.mat by eigenvector generated from Delay Matrix; stores under key 'xx'
# Shape: (854493,64), bad nodes: None, Threshold=0.2
# [max,min] = [15,-30]

# ====

# CoADly2Trans.mat: 
# transfers from gdat_env_HD06.mat by eigenvectors generated from Max-correlation Matrix*Delay Matrix; stores under key 'xx'
# Shape: (1062012,54), bad nodes: [8, 16, 18, 27, 30, 33, 39, 41, 42, 43], Threshold=0.2
# [max,min] = [17,-37]


# MaxCo2Trans.mat:
# transfers from gdat_env_HD06.mat by eigenvectors generated from Max-correlation Matrix; stores under key 'xx'
# Shape: (1062012,54), bad nodes: [8, 16, 18, 27, 30, 33, 39, 41, 42, 43], Threshold=0.2
# [max,min] = [20,-40]

# Co2Trans.mat:
# transfers from gdat_env_HD06.mat by eigenvectors generated from Correlation Matrix; stores under key 'xx'
# Shape: (1062012,52), bad nodes: [8, 16, 18, 27, 30, 33, 37, 38, 39, 41, 42, 43], Threshold=0.2
# [max,min] = [25,-40]


# Delay2Trans.mat:
# transfers from gdat_env_HD06.mat by eigenvector generated from Delay Matrix; stores under key 'xx'
# Shape: (1062012,64), bad nodes: None, Threshold=0.2
# [max,min] = [25,-40]


# CoADly3Trans.mat: 
# transfers from gdat_env_HD06_sp.mat by eigenvectors generated from Max-correlation Matrix*Delay Matrix; stores under key 'xx'
# Shape: (988770,62), bad nodes: [16, 30], Threshold=0.1
# [max,min] = [6,-3]

# MaxCo3Trans.mat:
# transfers from gdat_env_HD06_sp.mat by eigenvectors generated from Max-correlation Matrix; stores under key 'xx'
# Shape: (988770,63), bad nodes: [30], Threshold=0.1
# [max,min] = [6,-3]

# Co3Trans.mat:
# transfers from gdat_env_HD06_sp.mat by eigenvectors generated from Correlation Matrix; stores under key 'xx'
# Shape: (988770,52), bad nodes:[1, 7, 16, 24, 30, 32, 37, 40, 41, 42, 43, 58], Threshold=0.1
# [max,min] = [3,-6]

# Delay3Trans.mat:
# transfers from gdat_env_HD06_sp.mat by eigenvector generated from Delay Matrix; stores under key 'xx'
# Shape: (988770,64), bad nodes: None, Threshold=0.2
# [max,min] = [3,-6]
...
dataset_filename_ecog=[['graph/Delay1Trans.mat'],
				       ['graph/Delay2Trans.mat','graph/Delay3Trans.mat']]
...
#####CoADly1Trans######
# data_range_max = [[33],[17,6]]
# data_range_min = [[-12],[-37,-3]]
#####Maxco1Trans#######
# data_range_max = [[30],[20,6]]
# data_range_min = [[-25],[-40,-3]]
#####Delay2Trans#######
# data_range_max = [[15],[25,3]]
# data_range_min = [[-28],[-40,-6]]
#####Co1Trans#######
data_range_max = [[15],[25,3]]
data_range_min = [[-30],[-40,-6]]
...
def read_all_data(): 
	...
	for ds in range(len(dataset_filename_ecog)):
		...
		for file in range(len(dataset_filename_ecog[ds])):
			ecogdata = scipy.io.loadmat(DATA_DIR+dataset_filename_ecog[ds][file])
			ecog = ecogdata['xx'][:,:48]
			ecog = np.minimum(ecog,data_range_max[ds][file])
			ecog = np.maximum(ecog,data_range_min[ds][file])
