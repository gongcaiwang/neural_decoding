...
def read_all_data(): 
	...
	spkr = np.concatenate([spkrspec_train,spkrspec_test],axis=0)[:-1]
	...
	return net, nst, nett, nstt, ecog,spkr,spkrspec_train,spkrspec_test, label_train,label_test,start_ind_train,start_ind_test,target_train,target_test,peseudo_train,peseudo_test,word_window_train,word_window_test
