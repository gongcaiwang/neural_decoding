...
# LOAD_DIR = './log/'+'myCNN2_wavenet_stft_cv_hd06_encode_causal_20180717-165105'+'/model_step_3000_cv0' #causal cnn, l2 0.01, fw=100
# LOAD_DIR = './log/'+'myCNN2_wavenet_stft_cv_hd06_encode_causal_20180717-170044'+'/model_step_3000_cv0' #causal cnn, l2 0.01, fw=57
# LOAD_DIR = './log/'+'myCNN2_wavenet_stft_cv_hd06_encode_causal_20180717-170338'+'/model_step_3000_cv0' #causal cnn, l2 1, fw=57
LOAD_DIR = './log/'+'myCNN2_wavenet_stft_cv_hd06_encode_causal_20180717-170930'+'/model_step_3000_cv0' #causal cnn, l2 0.1, fw=57
...
def network_wavenet(input_batch, keep_prob, train_phase, reuse=None, name='G'):
    with tf.variable_scope('generator_common_layers',reuse=reuse):
        current = conv(input_batch,num_outputs=depth,kernel_size=linear_conv_filter_width, scope = 'out', activation_fn=None,stride=1,padding='VALID')
...
y_ = tf.placeholder(tf.float32, shape=[None, width_+linear_conv_filter_width-1, depth_])  # [None, 10]
