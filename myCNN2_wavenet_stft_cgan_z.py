...
import sys
from myLib_wavenet_stft_cgan_z import *
...
def generator_wave(x, z, keep_prob, train_phase, reuse=None, name=None):
    with tf.variable_scope('generator_z_layers',reuse=reuse):
        current = z
        ...
        current = res_block_dis(current, num_outputs=32,kernel_size=2,train_phase=train_phase, scope = 'res0_0', rate = 1, resample='up', mode ='generator')
        current = res_block_dis(current, num_outputs=32,kernel_size=2,train_phase=train_phase, scope = 'res0_1', rate = 1, resample='up', mode ='generator')
        current_z = res_block_dis(current, num_outputs=32,kernel_size=2,train_phase=train_phase, scope = 'res0_2', rate = 1, resample='up', mode ='generator')
    with tf.variable_scope('generator_x_layers',reuse=reuse):
        current = x
        current = res_block_dis(current, num_outputs=32,kernel_size=4,train_phase=train_phase, scope = 'res1', rate = 1, mode ='generator')
        current = res_block_dis(current, num_outputs=32,kernel_size=4,train_phase=train_phase, scope = 'res2', rate = 4, mode ='generator')
        current = res_block_dis(current, num_outputs=32,kernel_size=4,train_phase=train_phase, scope = 'res3', rate = 16, mode ='generator')
        current = res_block_dis(current, num_outputs=32,kernel_size=4,train_phase=train_phase, scope = 'res4', rate = 1, resample ='down', mode ='generator')
        current = res_block_dis(current, num_outputs=32,kernel_size=4,train_phase=train_phase, scope = 'res5', rate = 4, mode ='generator')
        current = res_block_dis(current, num_outputs=32,kernel_size=4,train_phase=train_phase, scope = 'res6', rate = 16, mode ='generator')
        current = res_block_dis(current, num_outputs=32,kernel_size=4,train_phase=train_phase, scope = 'res7', rate = 1, resample ='down', mode ='generator')
        current = res_block_dis(current, num_outputs=32,kernel_size=2,train_phase=train_phase, scope = 'res8', rate = 4, mode ='generator')
        current_x = res_block_dis(current, num_outputs=32,kernel_size=2,train_phase=train_phase, scope = 'res9', rate = 16, mode ='generator')
    with tf.variable_scope('generator_common_layers',reuse=reuse):
        current = tf.concat([current_z,current_x[:,8:-8]],axis=-1)
